...
export default async function EditInvoicePage({ params }: PageProps) {
  ...
  // Fetch target invoice, profile, and settings
  const [
    { data: invoiceData },
    { data: profileData },
    { data: companyData },
  ...
  const companySettings: CompanySettings = companyData || invoice.company_snapshot || {
  ...
  const bankSettings: BankSettings = bankData || invoice.bank_snapshot || {
  ...
  const qrSettings: QrSettings = qrData || invoice.qr_snapshot || {
    qr_enabled: true,
    qr_image_url: '',
